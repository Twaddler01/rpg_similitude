...
- Still need enemy array data revamped for different battle setups using new location/level design.
...
- TEMP: "Prepare Battle" adds kill counts as if enemy was defeated.
